...
config = {
    ...
    "serviceAccount": "C:\\FrontEnd-1\\Project\\phoneHub\\Project\\service-account-file.json",
...
def blogs(request):
    ...
    return render(request, 'blogs/blogs.html', {'userr': user, 'blogs': blogss, 'template': 'Blog'})
...
def home(request):
    ...
    global user
    if user:
        return render(request, 'home/index.html', {'userr': user, 'template': "Home"})
    return render(request, 'home/index.html', {'template': 'Home'})


def compare(request):
    if user:
        return render(request, 'compare/compare.html', {'userr': user, 'template': 'Compare'})
    return render(request, 'compare/compare.html', {'template': 'Compare'})
...
def sendEmail(toemail, msg1, msg2):
    send_mail(msg1, msg2, 'phonehub.arham.pk1@gmail.com',
